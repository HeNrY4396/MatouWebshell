...
function run(){
    ...
    if (strpos($content_type, 'application/x-www-form-urlencoded') !== false) {
        ...
        $pms = aesDecrypt(base64_decode($encrypted_data_base64), $secret_key);
        ...
        $pms = aesDecrypt($encrypted_data, $secret_key);
    ...
    $final_data = $response_marker['left'] . $result . $response_marker['right'];
    
    createPngResponse($final_data);
